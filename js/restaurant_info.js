...
/**
 * Initialize map as soon as the page is loaded / on DOMContentLoaded.
 */
  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) { // Got an error!
      ...
      L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
        mapboxToken: 'pk.eyJ1IjoiYWxiZXJ0Y29kZXIiLCJhIjoiY2pyYjhjbHh6MTBjazQ5cGhxeHA0Nml6byJ9.UnEuJ8Th9Gf_kWiNwYuaKA',
        maxZoom: 18,
...
/**
 * Get the current restaurant from the URL currently.
 */
...
/**
 * Create restaurant hours of operating HTML table and add it to the webpage.
 */
